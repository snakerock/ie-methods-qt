...
#include "../ie-methods-qt/formulaview.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FormulaView_t, stringdata) + ofs \
...
QT_MOC_LITERAL(12, 131, 6)
    ...
    "drawFrames\0setColors\0colors\0"
};
...
const QMetaObject FormulaView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FormulaView.data,
      qt_meta_data_FormulaView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FormulaView.stringdata))
